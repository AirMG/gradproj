...
class MobileNetV2Encoder(MobileNetV2):
    ...
    def __init__(self, in_channels, norm_layer=None):
        ...
        self.layer4 = nn.Sequential(self.features[7], self.features[8],self.features[9],self.features[10],self.features[11],self.features[12],self.features[13])
